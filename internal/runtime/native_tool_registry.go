...
Use TodoWrite for multi-step work when progress tracking is genuinely helpful, especially across file edits, tests, and sub-agent coordination.
			...
			Parameters: map[string]interface{}{
				...
				"properties": map[string]interface{}{
					"todos": map[string]interface{}{
						"type":        "array",
						"description": "Complete ordered todo list. Every call replaces the entire current list.",
						"items": map[string]interface{}{
							"type": "object",
							"properties": map[string]interface{}{
								"content":  map[string]interface{}{"type": "string", "description": "Brief description of the task"},
								"status":   map[string]interface{}{"type": "string", "description": "Current task state", "enum": []string{"pending", "in_progress", "completed", "cancelled"}},
								"priority": map[string]interface{}{"type": "string", "description": "Task priority", "enum": []string{"high", "medium", "low"}},
							},
