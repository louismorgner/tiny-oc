...
var nativeModelProfiles = []NativeModelProfile{
	...
	// --- Small / utility models (used as small_model for compaction and summarization) ---
	{
		...
		Label:             "GPT-4.1 Mini",
		Description:       "fast, cheap OpenAI model for summarization and utility tasks",
		SupportsTools:     true,
		SupportsStreaming: true,
	...
	},
	{
		...
		Label:             "GPT-4.1 Nano",
		Description:       "cheapest OpenAI model for lightweight utility tasks",
		SupportsTools:     true,
		SupportsStreaming: true,
		ContextWindow:     1047576,
		MaxOutputTokens:   32768,
	...
	},
	{
		...
		Description:       "fast Anthropic model for summarization, extraction, and utility tasks",
		SupportsTools:     true,
		SupportsStreaming: true,
		SupportsThinking:  true,
		ContextWindow:     200000,
